...
# Tapi Jangan di Hapus Special Thanks To nya Yaaa :'D
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "💬 Channel Updates", url=f"https://t.me/n0thingspeciall"), 
                    InlineKeyboardButton(
                        "🎈 Group Support", url=f"https://t.me/Cariteman_Virtual")
                ],[
                    InlineKeyboardButton(
                        "🛠 Source Code 🛠", url=f"https://{SOURCE_CODE}")
                ],[
                    InlineKeyboardButton(
                        "🎁 Donate", url=f"https://t.me/EntarSuren")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '💬 Channel Updates', url=f"https://t.me/n0thingspeciall"),
             InlineKeyboardButton(text = '🔰 Group Support', url=f"https://t.me/Cariteman_Virtual")],
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "📜 Cara Menggunakan BOT 📜", url="https://t.me/EntarSuren"
                    )
                ]
            ]
        ),
      ...
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "Created By", url=f"https://t.me/EntarSuren"
                    )
                ]
            ]
        )
